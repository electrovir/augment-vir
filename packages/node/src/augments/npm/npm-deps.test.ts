        ...
        assert.deepEquals(sanitizedDeps, {
            '@augment-vir/assert': [
                ...
                },
                {
                    dependencyKey: PackageJsonDependencyKey.Dependencies,
                    requiredBy:
                        '/Users/electrovir/repos/electrovir/augment-vir/packages/scripts/package.json',
                    isWorkspace: true,
                },
                {
                    dependencyKey: PackageJsonDependencyKey.Dependencies,
                ...
                },
                {
                    dependencyKey: PackageJsonDependencyKey.Dependencies,
                    requiredBy:
                        '/Users/electrovir/repos/electrovir/augment-vir/packages/web/package.json',
                    isWorkspace: true,
                },
            ],
            '@augment-vir/common': [
            ...
            '@date-vir/duration': [
                ...
                },
                {
                    dependencyKey: PackageJsonDependencyKey.Dependencies,
                    requiredBy:
                        '/Users/electrovir/repos/electrovir/augment-vir/packages/core/package.json',
                    isWorkspace: false,
                },
                {
                    dependencyKey: PackageJsonDependencyKey.Dependencies,
