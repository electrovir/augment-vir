...
describe(replaceStringAtIndex.name, () => {
    ...
    itCases(replaceStringAtIndex, [
        ...
        },
        {
            ...
            inputs: [' a b c', 0, ' super duper thing', 6],
