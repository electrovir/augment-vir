    ...
    it('waits for resolution', async () => {
        ...
        assert.deepEquals(
            readState(),
            {
                ...
                events: [],
                addResults: [],
                promises: [false, false, false, false, false, false],
            },
        ...
        assert.deepEquals(
            readState(),
            {
                ...
                events: [],
                addResults: [],
                promises: [false, true, false, false, false, false],
            },
        ...
        await waitUntil.deepEquals(
            {
                ...
                addResults: ['resolved', 'resolved'],
                promises: [true, true, false, false, false, false],
            },
            readState,
            undefined,
        ...
        await waitUntil.deepEquals(
            {
                ...
                addResults: ['resolved', 'resolved', 'rejected'],
                promises: [true, true, true, false, false, false],
            },
            readState,
            undefined,
        ...
        await waitUntil.deepEquals(
            {
                ...
                addResults: ['resolved', 'resolved', 'rejected', 'resolved'],
                promises: [true, true, true, true, false, false],
            },
            readState,
            undefined,
        ...
        await waitUntil.deepEquals(
            {
                ...
                addResults: ['resolved', 'resolved', 'rejected', 'resolved', 'resolved'],
                promises: [true, true, true, true, true, false],
            },
            readState,
            undefined,
        ...
        await waitUntil.deepEquals(
            {
                ...
                promises: [true, true, true, true, true, true],
            },
            readState,
            undefined,
